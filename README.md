...
document.addEventListener("DOMContentLoaded", function () {
    const target = document.querySelector("#id-o-clase-del-elemento");
    if (target && target.textContent.includes("Suscribirse a: Entradas (Atom)")) {
    ...
    <!-- Popup de anuncio (mostrado al inicio) -->
    <div id="overlay">
        <div id="popup">
            <h2><i class="fas fa-ad"></i> Espera 10 segundos</h2>
            <p>El anuncio se cerrará automáticamente</p>
            <div id="countdown">10</div>
            <p>¡Gracias por tu apoyo!</p>
            <div style="margin-top: 15px;">
                <script type="text/javascript">
                    atOptions = {
                        'key' : 'c9e3a93a071a563b36e503c69eda88ef',
                        'format' : 'iframe',
                        'height' : 250,
                        'width' : 300,
                        'params' : {}
                ...
                <script type="text/javascript" src="//abnormalitylovingmammal.com/c9e3a93a071a563b36e503c69eda88ef/invoke.js"></script>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Contador regresivo de 10 segundos para el anuncio
            let seconds = 10;
            ...
            // Prevenir que el anuncio se cierre al hacer clic
            popup.addEventListener('click', function(e) {
                e.stopPropagation();
            });
            
            // Permitir cerrar el anuncio solo haciendo clic fuera
            overlay.addEventListener('click', function() {
                // No hacer nada - el anuncio solo se cierra automáticamente
            });
        });
    </script>
